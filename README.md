# Streamdata.io API Gallery - Bureau of Labor Statistics Profiling
This is a repository for managing the profiling of Bureau of Labor Statistics. Right now, it is just a Github repository, README, and an [APIs.json](apis.md) outlining some of the details of Bureau of Labor Statistics, including different links and artificats defining their operation.
...
Once there is an OpenAPI for Bureau of Labor Statistics, it will be available within the [Streamdata.io API Gallery](http://api.gallery.streamdata.io/), until then the companies profile will be used in a variety of other sites and applications.
